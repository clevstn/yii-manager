    ...
    <div class="login-wrap">
        <div class="panel-body">
            <div class="login-header">
                ...
                <p class="login-title"><?= Yii::$app->params['admin_title'] . t('sign in', 'app.admin') ?></p>
            </div>
        </div>
        <div class="panel-body">
            <form class="p-24 pt-0">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control focus-define" id="usernameOrEmail" name="usernameOrEmail" placeholder="<?= t('the email/username', 'app.admin') ?>" autocomplete="off" ng-model="usernameOrEmail" ng-blur="checkUser()">
                    </div>
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="next-step btn btn-primary" ng-click="loginSubmit()"><?= t('sign in', 'app.admin') ?></button>
            </form>
        </div>

        <!--其他登录方式-->
        <!--<div class="panel-body pt-0 top-line">
            <p class="other-loginway"><?= t('other login methods', 'app.admin') ?></p>
