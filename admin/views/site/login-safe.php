...
$this->title = t('safety certification');
    ...
    <form class="panel panel-default mt-50">
                ...
                <div class="panel-body">
                    <div class="item-group">
                        <div class="item-group-row">
                            <span class="item-label"><?= t('authentication methods') ?></span>
                            <div class="item-body">
                        ...
                        <div class="item-group-row">
                            <span class="item-label"><?= t('mail verification code') ?></span>
                            <div class="item-body">
                        ...
                        <?php break; case AdminUser::SAFE_AUTH_MESSAGE: // 短信认证?>
                            <div class="item-group-row">
                                <span class="item-label"><?= t('SMS verification code') ?></span>
                                <div class="item-body">
                        ...
                        <?php break; case AdminUser::SAFE_AUTH_OTP: // OTP认证?>
                            <div class="item-group-row">
                                <span class="item-label"><?= t('OTP Numbers') ?></span>
                                <div class="item-body">
                        ...
                        <div class="item-group-row">
                            ...
                            <div class="item-body"><?= t('unknown authentication method') ?></div>
                        </div>
                        <?php endswitch; ?>
                    </div>
                </div>
        ...
        <div class="panel-body p-24 row">
            <div class="col-xs-10 col-xs-offset-1 row">
                <button type="button" class="btn btn-default btn-lg col-xs-5 border-radius-none" ng-click="backLog()"><?= t('switch to another account') ?></button>
                <button type="submit" class="btn btn-primary btn-lg col-xs-5 col-xs-offset-2 border-radius-none" ng-click="continueLog('<?= $safeWay ?>')"><?= t('continue to login') ?></button>
            </div>
        </div>
    </form>
</div>
